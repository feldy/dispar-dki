...
TRUNCATE TABLE `m_daerah_jenis`;
--
-- Dumping data for table `m_daerah_jenis`
--

INSERT INTO `m_daerah_jenis` (`id_jenis`, `nama`) VALUES
('1', 'kabupaten'),
('2', 'kota'),
('3', 'kelurahan'),
('4', 'desa');
...
--
-- Truncate table before insert `m_daerah_kabupaten`
--

TRUNCATE TABLE `m_daerah_kabupaten`;
--
-- Dumping data for table `m_daerah_kabupaten`
--

INSERT INTO `m_daerah_kabupaten` (`id_kab`, `id_prov`, `nama`, `id_jenis`) VALUES
...
--
-- Truncate table before insert `m_daerah_kecamatan`
--

TRUNCATE TABLE `m_daerah_kecamatan`;
--
-- Dumping data for table `m_daerah_kecamatan`
--

INSERT INTO `m_daerah_kecamatan` (`id_kec`, `id_kab`, `nama`) VALUES
INSERT INTO `m_daerah_kecamatan` (`id_kec`, `id_kab`, `nama`) VALUES
...
--
-- Truncate table before insert `m_daerah_kelurahan`
--

TRUNCATE TABLE `m_daerah_kelurahan`;
--
-- Dumping data for table `m_daerah_kelurahan`
--

INSERT INTO `m_daerah_kelurahan` (`id_kel`, `id_kec`, `nama`, `id_jenis`) VALUES
('3201372005', '320137', 'Sukmajaya', '4'),
('3276051001', '327605', 'Sukmajaya', '3'),
('3672051001', '367205', 'Sukmajaya', '3'),
('7503072009', '750307', 'Sukma', '4');

--
-- Truncate table before insert `m_daerah_provinsi`
--

TRUNCATE TABLE `m_daerah_provinsi`;
--
-- Dumping data for table `m_daerah_provinsi`
--

INSERT INTO `m_daerah_provinsi` (`id_prov`, `nama`) VALUES
('11', 'Aceh'),
('12', 'Sumatera Utara'),
('13', 'Sumatera Barat'),
('14', 'Riau'),
