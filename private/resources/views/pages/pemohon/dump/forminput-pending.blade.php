...
@section('content')
    <div class="container">
        ...
        <section class="content">
            <h3 class="box-title">Data Detail Permohonan</h3>
                        ...
                        <table class="table table-responsive table-hover no-border">
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <dd>
                                        <small class="text-danger">(Gambar Kurang Jelas)</small>
                                    </dd>
                                </td>
                                <td class="text-right" width="140">
                                    <label class="btn bg-red btn-xs"><i class="fa fa-upload"></i> <judul>Upload</judul> <input name="upload_dok_ktp" style="display: none;" type="file"></label>
                                    <div type="button" class="btn btn-primary btn-xs" title="Clear"><em class="fa fa-trash"></em></div>
                                    <div class="btn btn-primary btn-xs btn-preview-image" title="View" src=""><em class="fa fa-eye"></em></div>
                                </td>
                            </tr>
                            <tr>
                                <td width="15px">2.</td>
                            ...
                            <tr>
                                ...
                                <td class="text-right" width="140">
                                    <div class="label btn-xs bg-green"><judul>Verified</judul></div>
                                    <div class="btn btn-primary btn-xs btn-preview-image" title="View" src=""><em class="fa fa-eye"></em></div>
                                </td>
                            </tr>
                            <tr>
