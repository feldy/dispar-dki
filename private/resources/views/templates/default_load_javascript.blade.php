...
{{--<script src="{{ asset('assets/bootstrap/css/jquery-2.2.3.min.js') }}" type="text/javascript"></script>--}}
<!-- Bootstrap 3.3.6 -->
...
<script src="{{ asset('assets/bootstrap/js/demo.js') }}" type="text/javascript"></script>
<!-- custom file input -->
<script src="{{ asset('assets/bootstrap/js/file-input-custom.js') }}" type="text/javascript"></script>
